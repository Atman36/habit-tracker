    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
      <Card>
        <CardContent className="p-4 text-center">
          ...
          <div className="text-sm text-muted-foreground">{t.achievements.stats.level}</div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-4 text-center">
          ...
          <div className="text-sm text-muted-foreground">{t.achievements.stats.legendary}</div>
        </CardContent>
      </Card>
    </div>
  );
        ...
        <div className="overflow-y-auto">
          ...
          <Tabs defaultValue="all" className="w-full">
            <TabsList className="grid w-full grid-cols-4">
              ...
              <TabsTrigger value="unlocked">{t.achievements.tabs.unlocked}</TabsTrigger>
              <TabsTrigger value="locked">{t.achievements.tabs.inProgress}</TabsTrigger>
              <TabsTrigger value="categories">{t.achievements.tabs.categories}</TabsTrigger>
            </TabsList>
